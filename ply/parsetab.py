...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','m_yacc.py',13),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','m_yacc.py',17),
  ('expression -> term','expression',1,'p_expression_term','m_yacc.py',21),
  ('term -> term TIMES factor','term',3,'p_term_times','m_yacc.py',25),
  ('term -> term DIVIDE factor','term',3,'p_term_divide','m_yacc.py',29),
  ('term -> factor','term',1,'p_term_factor','m_yacc.py',33),
  ('factor -> NUMBER','factor',1,'p_factor_num','m_yacc.py',37),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expression','m_yacc.py',41),
]
